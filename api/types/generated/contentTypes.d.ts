...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Seo: Attribute.Component<'organisms.seo'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Blocks: Attribute.DynamicZone<['page.section']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    xUsername: Attribute.String & Attribute.Unique;
    websiteUrl: Attribute.String;
    title: Attribute.String & Attribute.Required;
    bio: Attribute.Text;
    profilePic: Attribute.Media;
    color: Attribute.Enumeration<['red', 'orange', 'amber', 'cyan']> &
      Attribute.Required &
      Attribute.DefaultTo<'cyan'>;
